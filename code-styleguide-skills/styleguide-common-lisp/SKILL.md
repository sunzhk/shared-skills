---
name: styleguide-common-lisp
description: Use when writing or reviewing common-lisp code and you need language-specific style conventions and checks.
---
...
- 本地：`sbcl --non-interactive --load your-system.asd --eval "(ql:quickload :your-system)"`
- CI：`sbcl --non-interactive --eval "(ql:quickload :your-system/test)"`
