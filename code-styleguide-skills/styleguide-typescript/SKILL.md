---
name: styleguide-typescript
description: Use when writing or reviewing typescript code and you need language-specific style conventions and checks.
---
...
- 本地：`eslint . --ext .ts,.tsx --fix && prettier -w .`
- CI：`tsc --noEmit && eslint . --ext .ts,.tsx && prettier -c .`
...
- [TypeScript Handbook（官方）](https://www.typescriptlang.org/docs/)
