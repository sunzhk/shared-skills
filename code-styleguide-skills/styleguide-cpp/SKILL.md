---
name: styleguide-cpp
description: Use when writing or reviewing cpp code and you need language-specific style conventions and checks.
---
...
- 本地：`clang-format -i $(rg --files -g "*.{h,hpp,cc,cpp,cxx}")`
- CI：`clang-format --dry-run --Werror $(rg --files -g "*.{h,hpp,cc,cpp,cxx}")`
