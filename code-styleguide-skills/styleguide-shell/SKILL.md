---
name: styleguide-shell
description: Use when writing or reviewing shell code and you need language-specific style conventions and checks.
---
...
- 本地：`shellcheck $(rg --files -g "*.sh")`
- CI：`shellcheck $(rg --files -g "*.sh")`
...
- [ShellCheck（官方）](https://www.shellcheck.net/)
